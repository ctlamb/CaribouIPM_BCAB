---
title: "BC AB Caribou IPM Appendix"
...
```{r trajectory by ECCC ecotype, echo=TRUE, fig.height=6, fig.width=18, message=FALSE, warning=FALSE}
sims.plot <- sims %>%
...
```{r plotbyherd, message=FALSE, warning=FALSE}
## prep data
trt.plot <- trt %>%
  filter(applied == 1) %>%
...
```{r summarize by ECCC, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r summarize by HV, echo=TRUE, message=FALSE, warning=FALSE}
...
### ECCC
```{r trt eff- BACI w ECCC ecotype, echo=TRUE, fig.height=9, fig.width=13, message=FALSE, warning=FALSE}
...
### Heard and Vagt 1998
```{r trt eff- BACI w HV1998 ecotype, echo=TRUE, message=FALSE, warning=FALSE}
...
```
### Compare results
```{r trt eff- BACI compare w BA, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r r and delta r by ECCC ecotype, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r individual by ECCC ecotype, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r individual by HV ecotype, echo=TRUE, fig.height=9, fig.width=13, message=FALSE, warning=FALSE}
...
```{r raw results ECCC ecotype, echo=TRUE, message=FALSE, warning=FALSE}
ggplot() +
...
```{r raw results HV1998 ecotype, echo=TRUE, message=FALSE, warning=FALSE}
ggplot() +
